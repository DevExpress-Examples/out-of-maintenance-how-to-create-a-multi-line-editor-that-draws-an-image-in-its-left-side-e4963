...
'			Me.customGridView1.OnSmartIconSelection += New ImageTextEdit.OnSmartIconSelectionEventHandler(Me.customGridView1_OnSmartIconSelection);
		...
		Private gridColumn1 As GridColumn
		Private gridColumn2 As GridColumn
		Private myRepositoryItemMemoEdit1 As MyRepositoryItemMemoEdit
		Private repositoryItemMemoEdit1 As RepositoryItemMemoEdit
