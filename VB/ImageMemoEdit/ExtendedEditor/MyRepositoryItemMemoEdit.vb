...
'#Region "Service"
        ...
        Public Shared Sub Register()
            Call EditorRegistrationInfo.Default.Editors.Add(New EditorClassInfo(EditorName, GetType(MyMemoEdit), GetType(MyRepositoryItemMemoEdit), GetType(MyMemoEditViewInfo), New MyMemoEditPainter(), True, EditImageIndexes.MemoEdit, GetType(DevExpress.Accessibility.BaseEditAccessible)))
        End Sub
...
'#End Region
        Protected Friend Function GetImage() As Image
            Dim args As IconSelectionEventArgs = New IconSelectionEventArgs(Nothing)
        ...
        Public Overrides Function GetBrick(ByVal info As PrintCellHelperInfo) As VisualBrick
            ...
            Dim imgBrick As ImageBrick = New ImageBrick()
        ...
        Protected Friend Overridable Sub RaiseOnIconSelection(ByVal e As IconSelectionEventArgs)
            Dim handler As IconSelectionEventHandler = CType(Events(_onSmartIconSelection), IconSelectionEventHandler)
